...
package com.example.administrator.myapplication.touchevent.test;
...
public class ViewGroupA extends RelativeLayout {
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        if (ev.getAction() == MotionEvent.ACTION_DOWN) {
            ...
            Log.e(TAG, Static.dispatchTouchEvent + "项目进度?");
        }
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        if (ev.getAction() == MotionEvent.ACTION_DOWN) {
            ...
            Log.e(TAG, Static.onInterceptTouchEvent);
        }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        if (event.getAction() == MotionEvent.ACTION_DOWN) {
            ...
            Log.e(TAG, Static.onTouchEvent+"正在测试,明天就测试完了");
        }
        return true;
    }
}
